...
from src.orchestration.layered_architecture_types import TaskResult, TaskType
...
def initialize_default_executors():
    ...
    try:
        ...
        from src.orchestration.langgraph_nodes.langgraph_agent_nodes import (
...
class MockTaskExecutor(TaskExecutor):
    ...
    def supported_task_types(self):
        from src.orchestration.layered_architecture_types import TaskType
        # 将字符串转换为TaskType枚举
        task_type_map = {
