...
{{
    ...
    def _initialize_ml_models(self):
        ...
        try:
            # 初始化复杂度预测模型
            from src.orchestration.reasoning.ml_framework.complexity_predictor import ComplexityPredictor
            self.complexity_predictor = ComplexityPredictor()
            auto_load_model(self.complexity_predictor, "complexity_predictor")
            
            # 初始化执行时间预测模型
            from src.orchestration.reasoning.ml_framework.execution_time_predictor import ExecutionTimePredictor
