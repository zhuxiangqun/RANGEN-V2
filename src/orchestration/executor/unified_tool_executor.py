...
from src.orchestration.executor.cli_executor import get_cli_executor, CLIExecutor

try:
    from src.orchestration.cli_anything_generator import CLIAnythingGenerator, get_cli_anything_generator
except ImportError:
...
def get_unified_tool_executor() -> UnifiedToolExecutor:
    ...
    if _unified_executor is None:
        from src.orchestration.agents.skill_registry import get_skill_registry
