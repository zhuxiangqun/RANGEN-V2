...
from src.orchestration.executor.execution_coordinator import AgentState, ExecutionCoordinator
...
class ReviewEnabledCoordinator(ExecutionCoordinator):
    ...
    def _record_judgment(self, state: AgentState, decision: str):
        """记录判断到评价系统"""
        try:
            from src.orchestration.validators.judgment_evaluation import (
