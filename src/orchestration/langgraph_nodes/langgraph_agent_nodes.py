...
class AgentNodes:
    ...
    async def memory_agent_node(self, state: ResearchSystemState) -> ResearchSystemState:
        ...
        # 🚀 学习集成：应用学习到的洞察
        try:
            from src.orchestration.langgraph_nodes.langgraph_learning_nodes import apply_learned_insights
        ...
        try:
            ...
            # 🚀 学习集成：收集学习数据
            try:
                from src.orchestration.langgraph_nodes.langgraph_learning_nodes import collect_node_learning_data, learn_from_node_execution
...
Sub-queries:"""
    ...
    async def knowledge_retrieval_agent_node(self, state: ResearchSystemState) -> ResearchSystemState:
        ...
        try:
            ...
            try:
                from src.orchestration.capability_service import get_capability_service
