...
使用方式:
    from src.orchestration.nlu_bridge.requirement_parser import RequirementParser
...
from src.orchestration.nlu_bridge.capability_type_detector import CapabilityType
...
class RequirementParser:
    ...
    async def parse(self, user_input: str, capability_type: CapabilityType = None) -> RequirementAnalysis:
        ...
        if capability_type is None and self._llm_client:
            try:
                from src.orchestration.nlu_bridge.capability_type_detector import CapabilityTypeDetector
