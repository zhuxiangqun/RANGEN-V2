...
class UnifiedEvidenceFramework:
    ...
    def _initialize_modules(
        ...
        try:
            from src.orchestration.reasoning.evidence_validator import EvidenceValidator
        ...
        try:
            from src.orchestration.reasoning.evidence_quality_assessor import EvidenceQualityAssessor
