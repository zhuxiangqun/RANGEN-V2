...
from src.orchestration.reasoning.models import ReasoningResult, ReasoningStep, Evidence
from src.orchestration.reasoning.cache_manager import CacheManager
from src.orchestration.reasoning.context_manager import ContextManager
from src.orchestration.reasoning.subquery_processor import SubQueryProcessor
from src.orchestration.reasoning.evidence_processor import EvidenceProcessor
from src.orchestration.reasoning.step_generator import StepGenerator
from src.orchestration.reasoning.prompt_generator import PromptGenerator
from src.orchestration.reasoning.answer_extraction.answer_extractor import AnswerExtractor
from src.orchestration.reasoning.learning_manager import LearningManager
from src.orchestration.reasoning.utils import Utils

# Phase 3 Imports
from src.orchestration.operators import ExtractionOperator, ComparisonOperator, SynthesisOperator, ToolUseOperator
from src.orchestration.reasoning_state import ReasoningState

# 🚀 修复：导入统一证据处理框架（用于类型检查和方法调用）
try:
    from src.orchestration.reasoning.unified_evidence_framework import UnifiedEvidenceFramework
except ImportError:
    UnifiedEvidenceFramework = None  # type: ignore

# 🚀 P0阶段：导入检索策略模块
try:
    from src.orchestration.reasoning.retrieval_strategies import QueryOrchestrator, HyDEStrategy
