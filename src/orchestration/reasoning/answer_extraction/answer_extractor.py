...
try:
    ...
    # 如果相对导入失败，尝试绝对导入
    from src.orchestration.reasoning.models import Evidence, ReasoningStep
...
class AnswerExtractor:
    ...
    def __init__(
        ...
        try:
            from src.orchestration.reasoning.cognitive_answer_extractor import CognitiveAnswerExtractor
        ...
        try:
            from src.orchestration.reasoning.hierarchical_answer_validator import HierarchicalAnswerValidator
            validator_config = {
                'use_nlp': True,
        ...
        try:
            ...
            if not prompt:
                ...
                if evidence_preprocessor and evidence:
                    try:
                        from src.orchestration.reasoning.evidence_preprocessor import ProcessedEvidence
