...
class RealReasoningEngine:
    ...
    def __init__(self):
        ...
        if self.dynamic_planner_enabled:
            try:
                from src.core.reasoning.ml_framework.dynamic_planner import DynamicPlanner
        ...
        if self.knowledge_transfer_enabled:
            try:
                from src.core.reasoning.ml_framework.cross_task_transfer import CrossTaskKnowledgeTransfer
