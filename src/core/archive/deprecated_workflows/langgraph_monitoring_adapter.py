...
#PV|LangGraph监控适配器
#HW|
#JX|解决监控系统重复建设问题，实现LangGraph原生监控与自定义监控系统的深度集成
#ZJ|提供统一的监控面板和智能告警路由
#MX|
#JB|> ⚠️ **DEPRECATED (2026-03-12)**
#JB|> 此模块未被生产代码使用。
#JB|> 实际监控使用: `from src.tools.monitoring.performance_monitor import PerformanceMonitor`
...
#JB|# 废弃警告
#JB|warnings.warn(
#JB|    "langgraph_monitoring_adapter.py is deprecated. Use PerformanceMonitor from src.tools.monitoring instead.",
