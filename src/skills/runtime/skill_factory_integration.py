...
# 导入 Skill Factory (已移动到 src/skill_factory)
try:
    from src.skills.factory.factory import SkillFactory
    from src.skills.factory.prototypes.classifier import SkillPrototypeClassifier, PrototypeType
    from src.skills.factory.quality_checks.checker import SkillQualityChecker
...
class FactoryIntegrationConfig:
    ...
    bundled_skills_dir: str = "./src/skills/runtime/bundled"
...
class SkillFactoryIntegration:
    ...
    async def test_and_fix_skill(
        ...
        """
        try:
            from src.orchestration.sandbox import SkillTester, SkillTestConfig, get_sandbox_executor
    ...
    def test_skill_simple(
        ...
        """
        try:
            from src.orchestration.sandbox import get_sandbox_executor
