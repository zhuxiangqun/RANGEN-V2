...
from src.interfaces.skill import SkillScope, SkillMetadata, ISkill
from src.skills.runtime.dynamic_executor import DynamicSkill
...
class EnhancedSkillRegistry:
    ...
    def __init__(self, base_path: str = "./src/skills/runtime/bundled"):
