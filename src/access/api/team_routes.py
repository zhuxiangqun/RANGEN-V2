...
async def execute_team(request: TeamExecuteRequest):
    ...
    - 执行步骤
    """
    from src.orchestration.executor.team_executor import TeamExecutor, TeamExecutionRequest, get_team_executor
...
async def list_teams():
    ...
    列出所有可用的 Team
    """
    from src.orchestration.executor.team_executor import get_team_executor
