...
from src.orchestration.sop_learning import get_sop_learning_system, SOPLevel, SOPCategory
...
async def create_sop(request: SOPCreateRequest) -> Dict[str, Any]:
    ...
    Returns:
        创建的SOP信息
    """
    from src.orchestration.sop_learning import StandardOperatingProcedure, SOPStep
