...
class WorkflowGraphBuilder:
    ...
    def _extract_node_descriptions_from_workflow(self, workflow) -> Dict[str, str]:
        ...
        try:
            from src.orchestration.langgraph_nodes.langgraph_unified_workflow import UnifiedResearchWorkflow
            ...
            from src.orchestration.langgraph_nodes.langgraph_config_nodes import feedback_collection_node
            ...
            from src.orchestration.langgraph_nodes.langgraph_capability_nodes import standardized_interface_adapter
