...
class ModelPerformanceTracker:
    ...
    def record_performance(self, model_name: str, metrics: Dict[str, Any]) -> None:
        ...
        with self.lock:
            ...
            if len(self.performance_data[model_name]) > config.DEFAULT_LIMIT:
                self.performance_data[model_name] = self.performance_data[model_name][-config.DEFAULT_LIMIT:]
...
class ModelConfigManager:
    ...
    def _get_default_configs(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'model_types': {
                'llm': {
                    'base_config': {'temperature': config.DEFAULT_HIGH_MEDIUM_THRESHOLD, 'max_tokens': config.DEFAULT_LIMIT0},
                    'supported_models': ['gpt-3.config.DEFAULT_TOP_K-turbo', 'gpt-4', 'claude-3']
                },
                'embedding': {
                ...
                'classification': {
                    'base_config': {'threshold': 0.config.DEFAULT_TOP_K},
...
class UnifiedModelManager:
    ...
    def __init__(self):
        ...
        self.health_check_interval = config.DEFAULT_TIMEOUT_MINUTES
        self.max_failures = 3
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        success_rate = successful / total if total > config.DEFAULT_ZERO_VALUE else 0
    ...
    def get_failover_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recent_switches": self.switch_history[-config.DEFAULT_TOP_K:] if self.switch_history else []
        }
