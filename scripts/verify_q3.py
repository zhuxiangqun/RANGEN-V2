...
q = {
    "id": "test_query_3",
    "text": "Is the number of wives of the founder of the Ming Dynasty in China an odd or even number?"
}

def log_debug(msg):
    timestamp = datetime.datetime.now().isoformat()
    with open("debug_trace.log", "a", encoding="utf-8") as f:
        f.write(f"[{timestamp}] [Q3] {msg}\n")
    print(f"[{timestamp}] [Q3] {msg}", flush=True)
