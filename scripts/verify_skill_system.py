...
try:
    from src.skills.runtime.llm_driven_executor import LLMSkillExecutor
...
try:
    from src.skills.runtime.ai_skill_trigger import AISkillTrigger, ai_auto_trigger_skills
...
print("\n[5] 测试 Skill 加载...")
try:
    from src.skills.runtime.ai_skill_trigger import AISkillTrigger
