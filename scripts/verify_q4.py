...
q = {
    "id": "test_query_4",
    "text": "Is the sum of the atomic numbers of the three elements that make up the main components of the air a prime number?"
}

def log_debug(msg):
    timestamp = datetime.datetime.now().isoformat()
    with open("debug_trace.log", "a", encoding="utf-8") as f:
        f.write(f"[{timestamp}] [Q4] {msg}\n")
    print(f"[{timestamp}] [Q4] {msg}", flush=True)
