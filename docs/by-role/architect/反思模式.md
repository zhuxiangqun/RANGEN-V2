...
位于`src/orchestration/reflection.py`，提供基础反思能力：
...
- [Reflection源代码](../../src/orchestration/reflection.py)
...
- [学习协调器（原src/core/learning_orchestrator.py已移除）](./CORE_PRINCIPLES.md)
