...
def test_research_executor_direct():
    """直接测试研究执行器"""
    print("🔍 直接测试研究执行器...")
...
def test_performance_optimizer_direct():
    """直接测试性能优化器"""
    print("⚡ 直接测试性能优化器...")
...
def test_security_enhancer_direct():
    """直接测试安全增强器"""
    print("🔒 直接测试安全增强器...")
...
def test_code_quality_enhancer_direct():
    """直接测试代码质量增强器"""
    print("📝 直接测试代码质量增强器...")
...
def test_agent_template_direct():
    """直接测试智能体模板"""
    print("🤖 直接测试智能体模板...")
...
def test_intelligent_learning_direct():
    """直接测试智能学习模块"""
    print("🧠 直接测试智能学习模块...")
...
def main():
    ...
    tests = [
        test_research_executor_direct,
        test_performance_optimizer_direct,
        test_security_enhancer_direct,
        test_code_quality_enhancer_direct,
        test_agent_template_direct,
        test_intelligent_learning_direct
    ]
    ...
    if success_rate >= 80:
        ...
        print("⚠️ 核心功能测试部分通过，需要进一步优化")
    else:
        print("❌ 核心功能测试失败，需要修复关键问题")
