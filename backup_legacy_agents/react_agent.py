...
from backup_legacy_agents.base_agent import BaseAgent, AgentResult, AgentConfig
...
# from src.agents.tools.rag_tool import RAGTool  # 延迟导入，在_register_default_tools中使用
